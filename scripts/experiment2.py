...
parser.add_argument("--perturbation", dest="perturbation", default=0.02,
                    help="Perturbation from time to time")
...
n_times = 10
n_signals = [100]*n_times # number of signals at each time point
...
save_dir = "data/outputs/experiment2/{}_graph_param_{:.3f}_nruns_{:d}_pert_{:.3f}".format(
    graph_model, graph_param, n_runs, perturbation
)
